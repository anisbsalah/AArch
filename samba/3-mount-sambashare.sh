...
#echo -e "\n//${IP_ADDRESS}/sambashare	${HOME}/SAMBASHARE	cifs	x-systemd.automount,_netdev,nofail,credentials=${HOME}/.smbcred,noperm	0	0" | sudo tee -a /etc/fstab
echo -e "\n//${IP_ADDRESS}/sambashare	${HOME}/SAMBASHARE	cifs	_netdev,nofail,credentials=${HOME}/.smbcred,noperm	0	0" | sudo tee -a /etc/fstab
